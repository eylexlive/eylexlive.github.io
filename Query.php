...
class Query {
	...
	public function get() {
		...
		require "McFavicon.php";
		$favicon = new McFavicon($this->address, $this->port, 2);
		...
		$info['general']['favicon'] = $favicon;
		if(isset($info['general']['maxplayers']) && $info['general']['maxplayers']) $info['general']['online'] = 1; else $info['general']['online'] = 0;
