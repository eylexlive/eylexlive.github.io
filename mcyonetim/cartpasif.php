...
$query_onay = "SELECT * FROM cart WHERE servisdurumu = '2' ORDER BY siparisID DESC";
...
<ul class="nav nav-pills">
    ...
    <li class="active"><a href="?mc=cartpasif"><i class="fa fa-flag"></i> Hizmet Süresi Sona Eren Siparişler</a></li>
...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h3 class="panel-title"><i class="fa fa-shopping-basket"></i> Hizmet Süresi Sona Eren Siparişler </h3>
  </div>
  <div class="panel-body">
    <?php if ($totalRows_onay == 0) { // Show if recordset empty ?>
  <center><h1>Hizmet Süresi Sona Eren Sipariş bulunamadı!</h1></center>
