...
$ins_pages = new tNG_insert($conn_baglanti);
...
$ins_pages->registerTrigger("END", "Trigger_Default_Redirect", 99, "index.php?mc=pages");
// Add columns
$ins_pages->setTable("pages");
$ins_pages->addColumn("pageheadtitle", "STRING_TYPE", "POST", "pageheadtitle");
$ins_pages->addColumn("pagetitle", "STRING_TYPE", "POST", "pagetitle");
$ins_pages->addColumn("pagecontent", "STRING_TYPE", "POST", "pagecontent");
$ins_pages->addColumn("pagedate", "DATE_TYPE", "POST", "pagedate");
$ins_pages->addColumn("pageactive", "STRING_TYPE", "POST", "pageactive");
$ins_pages->setPrimaryKey("id", "NUMERIC_TYPE");
...
<ul class="nav nav-pills">
    ...
    <li  class="active"><a href="?mc=pagesadd"><i class="fa fa-file-o"></i> Yeni Sayfa Ekle</a></li>
  
</ul>
<hr />
<div class="panel panel-success">
  <div class="panel-heading">
    <h3 class="panel-title"><i class="fa fa-file-o"></i> Yeni Sayfa Ekle</h3>
  </div>
...
//]]>
        ...
        <tr>
          ...
          <td height="45"><input name="pagedate" type="text" class="form-control" id="pagedate" value="<?php echo tarihcevir(date("m/d/Y H:i")); ?><?php echo KT_formatDate($row_rspages['pagedate']); ?>" size="32" readonly="readonly" />
        ...
        <tr class="KT_buttons">
          <td height="45">&nbsp;</td>
          <td height="45"><input type="submit" class="btn btn-primary" name="KT_Insert1" id="KT_Insert1" value="KAYDET" /> Bu sayfayı ekleyen editör; <strong><?php echo $_SESSION['kt_username']; ?></strong></td>
        </tr>
      </table>
    </form>
    <p>&nbsp;</p>
