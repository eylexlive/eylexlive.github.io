...
'LOGIN_MESSAGE_LABEL' => '<strong>Mesaj:</strong>',
'LOGIN_FAILED' => '<div class="alert alert-error">Login failed.',
'LOGIN_INVALID_USERNAME' => '<div class="alert alert-error">Kullanici Adiniz Hatali.',
'LOGIN_INVALID_PASSWORD' => '<div class="alert alert-error">Parolaniz Hatali.',
'LOGIN_FAILED_NO_ACTIVE_FIELD' => 'Internal error.',
'LOGIN_INACTIVE_USER' => '<div class="alert alert-error">Login failed. Please activate your account first.<br />To activate your account, you must click on the link sent to you in the activation e-mail.',
'LOGIN_INACTIVE_USER_FIELDERR' => '<div class="alert alert-error">Inactive user.',
'ACTIVATION_NOT_ENABLED' => '<div class="alert alert-error">Internal error.',
'ACTIVATION_NO_EMAIL' => '<div class="alert alert-error">Internal error.',
'ACTIVATION_WRONG_TABLE' => '<div class="alert alert-error">Internal error.',
'ACTIVATION_WRONG_P' => '<div class="alert alert-error">Internal error.',
'ACTIVATION_NO_ACTIVE_FIELD' => '<div class="alert alert-error">Internal error.',
'ACTIVATION_NO_PARAM_RANDOM' => '<div class="alert alert-error">Activation error.',
'LOGIN_RECORDSET_ERR' => '<div class="alert alert-error">Internal error.',
'ACTIVATION_NO_PARAM_EMAIL' => '<div class="alert alert-error">Activation error.',
'ACTIVATION_NO_RECORDS' => '<div class="alert alert-error">Activation error.',
'ACTIVATION_TOOMANY_RECORDS' => '<div class="alert alert-error">Activation error.',
'ACTIVATION_ALREADY_ACTIVE' => '<div class="alert alert-error">Activation error. This account has already been activated.',
'FORGOTPASS_NO_EMAIL' => '<div class="alert alert-error">Internal error.',
'FORGOTPASS_WRONG_TABLE' => '<div class="alert alert-error">Internal error.',
'FORGOTPASS_WRONG_PK' => '<div class="alert alert-error">Internal error.',
'FORGOTPASS_WRONG_EMAIL' => '<div class="alert alert-error">Forgot password error.',
'FORGOTPASS_WRONG_EMAIL_FIELDERR' => '<div class="alert alert-error">Specified e-mail address does not exist.',
'FORGOTPASS_TOOMANY_RECORDS' => '<div class="alert alert-error">Forgot password error.',
'FORGOTPASS_TOOMANY_RECORDS_FIELDERR' => '<div class="alert alert-error">More than one e-mail address found.',
'FORGOTPASS_INACTIVE_USER' => '<div class="alert alert-error">Forgot password error. Cannot change password of inactive users.',
'UPDATEPASS_NO_NEW_PASS' => '<div class="alert alert-error">Please type the New Password or leave both Old Password and New Password fields empty.',
'UPDATEPASS_NO_NEW_PASS_FIELDERR' => '<div class="alert alert-error">New Password field is empty.',
'UPDATEPASS_NO_OLD_PASS' => '<div class="alert alert-error">Please type the Old Password or leave both Old Password and New Password fields empty.',
'UPDATEPASS_NO_OLD_PASS_FIELDERR' => '<div class="alert alert-error">Old Password field is empty.',
'UPDATEPASS_NO_RECORD' => '<div class="alert alert-error">Internal error.',
'UPDATEPASS_TOMANY_RECORDS' => '<div class="alert alert-error">Internal error.',
'UPDATEPASS_WRONG_OLD_PASS' => '<div class="alert alert-error">There was an error updating your account. Wrong Old Password.',
'UPDATEPASS_WRONG_OLD_PASS_FIELDERR' => '<div class="alert alert-error">Wrong Old Password.',
'LOGIN_MESSAGE__REG_ACTIVATE' => '<div class="alert alert-error">Your account was created. Check your e-mail for details on activating your account.',
'LOGIN_MESSAGE__REG_EMAIL' => '<div class="alert alert-error">Your account was created. Check your e-mail for details.',
'LOGIN_MESSAGE__REG' => '<div class="alert alert-error">Your account was created.',
'LOGIN_MESSAGE__ACTIVATED' => '<div class="alert alert-error">Your account was activated. Please login.',
