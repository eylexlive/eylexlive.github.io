...
class upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->translation['file_error']                  = 'Hata oluştu. Lütfen tekrar deneyiniz.';
        $this->translation['local_file_missing']          = 'Dosya bulunamadı.';
        $this->translation['local_file_not_readable']     = 'Dosya okunamadı.';
        $this->translation['uploaded_too_big_ini']        = 'Hata oluştu (izin verilen boyuttan büyük dosya yükleyemezsiniz. Ancak php.ini dosyasından upload_max_filesize değerini yükselterek tekrar deneyebilirsiniz.).';
        $this->translation['uploaded_too_big_html']       = 'Hata oluştu (sayfanızda belirttiğiniz MAX_FILE_SIZE boyutundan büyük bir dosya yükleyemezsiniz.).';
        $this->translation['uploaded_partial']            = 'Hata oluştu (dosyanın sadece bir kısmı yüklenebildi).';
        $this->translation['uploaded_missing']            = 'Hata oluştu (dosya seçilmemiş).';
        $this->translation['uploaded_unknown']            = 'Hata oluştu (hata tesbit edilemedi).';
        $this->translation['uploaded_no_tmp_dir']         = 'Hata oluştu (yükleme klasörü eksik).';
        $this->translation['uploaded_cant_write']         = 'Hata oluştu (dosya diske yazdırılamadı).';
        $this->translation['uploaded_err_extension']      = 'Hata oluştu (dosya yüklemesi uzantıdan kaynaklı durduruldu).';
        $this->translation['try_again']                   = 'Hata oluştu. Lütfen tekrar deneyiniz.';
        $this->translation['file_too_big']                = 'Dosya izin verilenden büyük.';
        $this->translation['no_mime']                     = 'Dosya türü bulunamadı.';
        $this->translation['incorrect_file']              = 'Bu dosyanın uzantısı geçersiz.';
        $this->translation['image_too_wide']              = 'Fotoğraf izin verilenden çok geniş.';
        $this->translation['image_too_narrow']            = 'Fotoğraf izin verilenden çok dar.';
        $this->translation['image_too_high']              = 'Fotoğraf izin verilenden çok uzun.';
        $this->translation['image_too_short']             = 'Fotoğraf izin verilenden çok kısa.';
        $this->translation['ratio_too_high']              = 'Fotoğraf oranı çok yüksek (fotoğraf çok geniş).';
        $this->translation['ratio_too_low']               = 'Fotoğraf oranı çok düşük (fotoğraf çok uzun).';
        $this->translation['too_many_pixels']             = 'Fotoğraf izin verilenden büyük.';
        $this->translation['not_enough_pixels']           = 'Fotoğraf izin verilenden küçük.';
        $this->translation['file_not_uploaded']           = 'Dosya yüklenemedi. İşlem sonlandırıldı.';
        $this->translation['already_exists']              = '%s dosyası zaten var. Lütfen dosyanızın ismini değiştirerek tekrar deneyiniz.';
        $this->translation['temp_file_missing']           = 'Temp dizini doğru belirtilmemiş. İşlem sonlandırıldı.';
        $this->translation['source_missing']              = 'Dosyanızın içeriğinde izin vermeyen unsurlar var. İşlem sonlandırıldı.';
        $this->translation['destination_dir']             = 'Dosyaların yükleneceği dizin oluşturulamadı. İşlem sonlandırıldı.';
        $this->translation['destination_dir_missing']     = 'Dosyaların yükleneceği dizin oluşturulmamış. İşlem sonlandırıldı.';
        $this->translation['destination_path_not_dir']    = 'Dosyaların yükleneceği adres bir dizin değil. İşlem sonlandırıldı.';
        $this->translation['destination_dir_write']       = 'Dosyaların yükleneceği dizinin yazma izinlerinde(CHMOD) problem var. İşlem sonlandırıldı.';
        $this->translation['destination_path_write']      = 'Dosyaların yükleneceği adresin yazma izinlerinde(CHMOD) problem var. İşlem sonlandırıldı.';
        $this->translation['temp_file']                   = 'Geçici dizine (temp) yazılamıyor. İzinleri kontrol etmelisiniz. İşlem sonlandırıldı.';
        $this->translation['source_not_readable']         = 'Dosyanın içeriği okunamadı. İşlem sonlandırıldı.';
        $this->translation['no_create_support']           = '%s dosyası oluşturulamadı.';
        $this->translation['create_error']                = 'Kaynaktan %s fotoğrafı oluşturulurken hata oluştu.';
        $this->translation['source_invalid']              = 'Fotoğraf dosyası okunamadı. Dosyanın bir fotoğraf olduğundan emin misiniz?';
        $this->translation['gd_missing']                  = 'Sunucuda GD kütüphanesi olmadığı için işleme devam edemiyorsunuz.';
        $this->translation['watermark_no_create_support'] = '%s fotoğrafı oluşturulamadığı için filigran oluşturulamadı.';
        $this->translation['watermark_create_error']      = '%s fotoğrafı okunamadığı için filigran oluşturulamadı.';
        $this->translation['watermark_invalid']           = 'Bilinmeyen dosya türü. Filigran oluşturulamadı.';
        $this->translation['file_create']                 = '%s dosyası oluşturulamadı.';
        $this->translation['no_conversion_type']          = 'Belirtilen dosya türü dönüştürülemedi.';
        $this->translation['copy_failed']                 = 'Dosya kopyalanırken hata oluştu. copy() işlemi başarısız.';
