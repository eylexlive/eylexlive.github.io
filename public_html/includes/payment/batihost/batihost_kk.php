...
?>
<form action="https://batihost.com/vipgateway/viprec.php" method="post" id="payment">
  ...
  <input type="hidden" name="posturl" value="<?=URL?>/includes/payment/batihost/batihost_kk_post.php">
