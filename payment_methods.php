...
<head>
	...
	<title>Ödeme Yöntemleri / <?php echo $row_ayar['title']; ?></title>
...
<div class="panel" >
    <div class="heading">
        <span class="title"><i class="fa fa-credit-card"></i> ÖDEME YÖNTEMLERİ</span>
  </div>
    <div class="content">
	<table width="100%" border="0">
  <tr>
    <td height="45" bgcolor="#D6D6D6">&nbsp;&nbsp;&nbsp;&nbsp;Ödeme yöntemlerimiz</td>
  </tr>
  <tr>
    <td height="30" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<i class="fa fa-money"></i> HESABINIZDAKİ KREDİ SİSTEMİ İLE ÖDEME YÖNTEMİ</td>
  </tr>
  <tr>
    <td height="30" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<i class="fa fa-paypal"></i> PAYPAL İLE ÖDEME SİSTEMİ</td>
  </tr>
  <tr>
    <td height="30" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;<i class="fa fa-university"></i> HAVALE İLE ÖDEME YÖNTEMİ</td>
  </tr>
  <tr>
    <td height="30" bgcolor="#FFFFFF">&nbsp;&nbsp;&nbsp;Hesap Numaralarımız için <a href="account_information.php"><i class="fa fa-university"></i> tıklayınız</a></td>
  </tr>
  <tr>
